<template>
     <b-form style="padding:10px; background:#F2F2F2;" @submit="onSubmit" @reset="onReset" v-if="show">       
            ...
            <b-form-group label="Declaration Type(1:1):" >
              <b-form-select v-model="declaration.declarationType1" :options="declarationType1List" required>{{newDeclarationType1}}</b-form-select>
            </b-form-group>
            <b-form-group label="Declaration Type(1:2):">
              <b-form-select v-model="declaration.declarationType2" :options="declarationType2List" required></b-form-select>
            </b-form-group>
     </b-form>
</template>
